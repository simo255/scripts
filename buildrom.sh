...
# to activate the script type in your terminal, '$ chmod +x <filepath>/buildrom.sh' to make the script executable 
...
# the number of threads you would like to give. Example if you have 4 CPU Cores, then you can make 4 threads using '$ make bacon -j4'
